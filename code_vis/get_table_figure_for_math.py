...
REAL_DATASET_NAME = {
    'grads_algebra': 'Algebra',
    'grads_counting_probability': 'Counting',
    'grads_geometry': 'Geometry',
}

CAPTION_DATASET = {
    'grads_algebra': 'MATH-Algebra',
    'grads_counting_probability': 'MATH-Counting',
    'grads_geometry': 'MATH-Geometry',
}
...
def parse_args():
    ...
    parser.add_argument("--task_type", type=str, default='lighteval_math')
    # lighteval_math, lighteval_math_wrong_answer_shuffle
    parser.add_argument("--data_name", type=str, default='grads_algebra')
    # grads_algebra, grads_counting_probability, grads_geometry
    parser.add_argument("--attribute_list", type=list, default=['S_sum', 'S_ratio'])
    parser.add_argument("--table_label", type=str, default='math_')
...
if __name__ == "__main__":
    ...
    json_data_list = [json_data_2, json_data_3]
    ...
    text_list = ['Simplified CoT', 'Detailed CoT']
    draw_figure(args, curve_dict, figure_save_path, text_list, 25)
